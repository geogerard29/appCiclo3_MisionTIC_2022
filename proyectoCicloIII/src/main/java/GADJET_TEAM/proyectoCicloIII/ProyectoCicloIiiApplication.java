...
public class ProyectoCicloIiiApplication {
	...
	public static void main(String[] args) {
		...
		System.out.println("CREACION Y OBTENCION DE INSTANCIAS DE LA CLASE Empresa");
		System.out.println();
		...
		listaEmpleado.add(new Empleado(1, "Daniel Gonzalez", "dagh81.dg@gmail.com", "TGT GAMAS", Empleado.role.Operativo));
		listaEmpleado.add(new Empleado(2, "Gerard Gonzalez", "geremmanuel9@gmail.com", "GADJET", Empleado.role.Administrador));
		listaEmpleado.add(new Empleado(3, "Adriana Castillo", "adriana19@gmail.com", "Movistar", Empleado.role.Administrador));
		listaEmpleado.add(new Empleado(4, "Edna Romero", "edna19@gmail.com", "Pfizer", Empleado.role.Administrador));
		listaEmpleado.add(new Empleado(5, "Jhonatan Jimenez", "jhonatan19@gmail.com", "Casaval", Empleado.role.Operativo));
		...
		for (int i = 0; i < listaEmpleado.size(); i++) {
			...
			System.out.println((listaEmpleado.get(i).getId()) + ") "
					+ "Nombre: " + listaEmpleado.get(i).getName()
					+ ", email: " + listaEmpleado.get(i).getEmail()
					+ ", Empresa: " + listaEmpleado.get(i).getEnterprise()
					+ ", Rol: " + listaEmpleado.get(i).getRoleName());
		}
		System.out.println("----------------------------------------------------------------------------------------------------------------------");
		...
		System.out.println(listaEmpleado.get(2).getId() + ") "
				+ "Nombre: " + listaEmpleado.get(2).getName()
				+ ", Email: " + listaEmpleado.get(2).getEmail()
				+ ", Empresa: " + listaEmpleado.get(2).getEnterprise()
				+ ", Rol: " + listaEmpleado.get(2).getRoleName());
		System.out.println("----------------------------------------------------------------------------------------------------------------------");
		...
		listaEmpleado.get(2).setRoleName(Empleado.role.Operativo);
		...
		listaMovDinero.add(new MovimientoDinero(1, "compra al proovedor de empanadas, ", 500000.0, listaEmpleado.get(2).getName(), MovimientoDinero.typeTran.Ingreso));
		...
		for (int i = 0; i < listaMovDinero.size(); i++) {
			...
			System.out.println(listaMovDinero.get(i).getId() + ") "
					+ "Concepto: " + listaMovDinero.get(i).getConcept()
					+", Monto: " + listaMovDinero.get(i).getAmount()
					+ ", Usuario encargado: " + listaMovDinero.get(i).getUser()
					+ ", Tipo de Movimiento: " + listaMovDinero.get(i).getTipo());
		}
		System.out.println("----------------------------------------------------------------------------------------------------------------------");
		...
		System.out.println(listaMovDinero.get(2).getId() + ") "
				+ "Concepto: " + listaMovDinero.get(2).getConcept()
				+ ", Monto: " + listaMovDinero.get(2).getAmount()
				+ ", Usuario encargado: " + listaMovDinero.get(2).getUser()
				+ ", Tipo de Movimiento: " + listaMovDinero.get(2).getTipo());
		System.out.println("----------------------------------------------------------------------------------------------------------------------");
		...
		System.out.println(listaMovDinero.get(2).getId() + ") "
				+ "Concepto: " + listaMovDinero.get(2).getConcept()
				+ ", Monto: " + listaMovDinero.get(2).getAmount()
				+ ", Usuario encargado: " + listaEmpleado.get(2).getName()
				+ ", Tipo de Movimiento: " + listaMovDinero.get(2).getTipo());
		System.out.println("----------------------------------------------------------------------------------------------------------------------");
*/
